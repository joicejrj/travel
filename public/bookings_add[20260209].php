          ...
          <div id="tourDiv" class="border rounded-3 p-3 mt-3 bg-light" style="display:none;">
            ...
            <div id="tourResultsWrap">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="mb-0">Available Tour Packages</h6>
                <button type="button"
                        class="btn btn-sm btn-outline-primary"
                        id="addCustomPackageBtn"
                        data-bs-toggle="modal"
                        data-bs-target="#customPackageWizard">
                  <i class="fa fa-plus me-1"></i> Add Custom Package
                </button>
              </div>
            ...
            <script>
              function selectTour(idx, btn) {
                ...
                const tourTrano = document.getElementById('tourtrano');
                if (tourTrano) tourTrano.style.display = '';
                ...
                if (priceSummary) {
                  priceSummary.textContent = '£ ' + pkg.sell_price.toFixed(2);
                }
            ...
            <script>
              document.getElementById('changeTourBtn')
                .addEventListener('click', function () {
                  ...
                  const tourTrano = document.getElementById('tourtrano');
                  if (tourTrano) tourTrano.style.display = 'none';
