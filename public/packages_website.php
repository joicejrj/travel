...
<div class="card mb-0">
  <div class="card-body py-2">
    <form method="get" class="row g-2 align-items-center" id="packagesFilterForm">
      <input type="hidden" name="page" value="packages_website">
      ...
      <div class="col-auto">
        <?php if ($search): // || $status ?>
          <a href="?page=packages_website" class="btn btn-sm btn-secondary">
