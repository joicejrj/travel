  ...
  <div class="row g-4">
    ...
    <div class="col-lg-8">
      ...
      <div class="view-panel" id="view-overview">
        ...
        <div class="card mb-3">
          <div class="card-body">
            <?=$package['wordpress_url']!=''?'<a href="'.$package['wordpress_url'].'" class="btn btn-sm btn-outline-success py-0 px-1 float-end" target="_blank"><i class="fa fa-link"></i> Package URL</a>':''?>
            <h5>Destination</h5>
            <div class="text-muted d-flex align-items-center gap-4 flex-wrap">
              <span>📍 <?= htmlspecialchars($package['destination']??'-') ?></span>
              <span>⏱ <?= $package['duration_days'] ?>D / <?= $package['duration_nights'] ?>N</span>
      ...
      <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
          ...
          <div class="d-flex justify-content-between align-items-center mb-3">
            <span class="small text-muted">Additional Room rate</span>
            <span class="fw-medium text-success">
              <?= $currency ?> <?= number_format(($pricing['room_rate'] ?? 0), 2) ?>
            </span>
          </div>
          ...
          <div class="row g-4">
            ...
            <div class="col-md-6">
              ...
              <input type="text"
                     ...
                     value="<?= $package['origin']!=''?htmlspecialchars($package['origin']):'' ?>">
              <label class="form-label fw-medium mt-1">Destination</label>
              <input type="text"
                     name="destination"
                     class="form-control"
                     placeholder="e.g., Paris, France"
                     value="<?= $package['destination']!=''?htmlspecialchars($package['destination']):'' ?>">
            </div>
            ...
            <!-- Wordpress URL -->
            <div class="col-md-12">
              <label class="form-label fw-medium">Package URL (Optional)</label>
              <input type="text"
                     name="wordpress_url"
                     class="form-control"
                     placeholder="e.g. https://www.indiavacations.com/brahmaputra-river-island-cruise/"
                     value="<?= htmlspecialchars($package['wordpress_url']??"") ?>">
            </div>
  ...
  <div class="card shadow-sm" id="pricingView">
    <div class="card-body">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-4">
          <div class="border rounded p-3 h-100">
            <small class="text-muted">Additional Room rate</small>
