...
$name = $company = $industry = $trn = $phones = $phone = $whatsapp = $email = $enable_email = $enable_whatsapp = $address = $city = $state = $country = $services = $google_rating = $website = $type = $source = $photo = $photo1 = $agent_id = $user_name = $fil_emails = $fil_domains = $dob = $gender = '';

$is_edit = false; //($id > 0);

// If editing, fetch existing supplier
if ($id > 0) {
    if ($stmt = $mysqli->prepare("SELECT id, name, company, industry, trn, phones, phone, whatsapp, email, enable_email, enable_whatsapp, address, city, state, country, services, google_rating, website, type, source, photo, photo1, agent_id, fil_domains, fil_emails, dob, gender FROM customers WHERE id = ?")) { // and agent_id= ?
...
<div class="header border-bottom pb-2 mb-3x">
  <div class="d-flex flex-wrap flex-md-nowrap justify-content-between align-items-start gap-2">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
      <h4 class="mb-0 fw-bold" id="named"><?= $company!=''?htmlspecialchars($company)." /":"" ?> <?= $name!=''?htmlspecialchars($name):"" ?></h4>
      ...
      <button class="btn btn-outline-primary btn-sm tab-btn fw-bold" data-tab="bookings">Bookings</button>
      ...
      <div class="row h-100 jrow">
        ...
        <div class="col-md-8 col-section jleft">
            ...
            <script>
                ...
                <!-- bookigns section start -->
                <!-- Bookings Tab Content -->
                <div id="bookings-section" class="tab-section section-scroll" style="display:none">
                    ...
                    <div class="container1" style="padding-bottom:18px;">
                      ...
                      <div class="page-filters">
                        ...
                        <div class="filter-field" style="min-width: 100px; display: none;">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-header p-0 border-bottom-0">
                            ...
                            <ul class="nav nav-tabs w-100 px-3 pt-3" id="bookingTabs" role="tablist">
                              ...
                              <li class="nav-item ms-auto1" role="presentation" style="display: none;">
                                <span
                    ...
                    window.openFollowups = function(bookingId) {
                      ...
                      document.getElementById('add-followup-form').addEventListener('submit', function(e){
                        ...
                        fd.append('created_by_name', <?= json_encode(($_SESSION['person_name'] ?? 'Agent')) ?>);
        ...
        <div class="modal-body text-dark" id="info">
          <form id="info-wrapper" class="row g-3 text-black">
            ...
            <div class="col-md-4 settinginp">
                ...
                <select name="gender" id="gender" class="form-control form-control-sm rounded-pill">
                    <option <?=$gender!=''?($gender=='Male'?'selected':''):'selected'?>>Male</option><option <?=$gender=='Female'?'selected':''?>>Female</option><option <?=$gender=='Other'?'selected':''?>>Other</option>
                </select>
            </div>
...
function setContact() {
  ...
  $("#named").text(company + (company!=''?" /":"") + name);
  $("#typed").text(type);
      ...
      <form id="contactForm" enctype="multipart/form-data">
        <div class="modal-body p-4">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-3">
              <label for="contact_gender" class="form-label fw-semibold small mb-1">Gender</label>
              <select name="gender" id="contact_gender" class="form-control form-control-sm rounded-pill">
                <option>Male</option>
  ...
  $(document).on("click", ".edit-contact", function(){
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        $("#contact_gender").val(data.gender);
