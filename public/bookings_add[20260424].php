              ...
              <div class="card-body p-2">
                ...
                <div class="flight-tabs mb-2 d-flex justify-content-between align-items-center">
                  ...
                  <div class="trip-tabs">
                    ...
                    <button type="button" class="<?=$is_existing&&$booking['type_id']=='1'&&$booking['trip_type']=='MULTI_CITY'?'active':'d-none'?>" id="tpMultiCityTab" data-type="MULTI_CITY">
                        Multi City
                    </button>
                  </div>
                  <!-- RIGHT: Provider -->
