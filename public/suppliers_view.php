...
// Default form values
$id = $supplier_id = isset($_GET['id']) ? (int)$_GET['id'] : 0;
$name = $company = $industry = $phones = $phone = $whatsapp = $email = $enable_email = $enable_whatsapp = $address = $city = $state = $country = $services = $google_rating = $website = $type = $source = $photo = $photo1 = $agent_id = $user_name = $fil_emails = $fil_domains = '';

$is_edit = false; //($id > 0);

// If editing, fetch existing supplier
if ($id > 0) {
    if ($stmt = $mysqli->prepare("SELECT id, name, company, industry, phones, phone, whatsapp, email, enable_email, enable_whatsapp, address, city, state, country, services, google_rating, website, type, source, photo, photo1, agent_id, fil_domains, fil_emails FROM suppliers WHERE id = ?")) { // and agent_id= ?
...
// prevent add here
if(!$is_edit) {
    $site->redirect('index.php?page=suppliers');
}
...
<div class="header border-bottom pb-2 mb-3x">
  <div class="d-flex flex-wrap flex-md-nowrap justify-content-between align-items-start gap-2">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
      ...
      <!-- <button class="btn btn-xs btn-outline-primary text-dark fw-bold" onclick="openSitesModal(<?=$supplier_id?>);" title="View Sites"><i class="fa fa-map"></i></button> -->
      ...
      <div class="d-flex flex-wrap align-items-center gap-2">
        <span class="fw-semibold">Supplier Status:</span>
        <span class="badge 
                bg-<?=
      ...
      <div class="row h-100 jrow">
        ...
        <div class="col-md-8 col-section jleft">
                ...
                <div class="modal-content">
                  <div class="modal-header py-2">
                    <h6 class="modal-title fw-semibold" id="paymentModalLabel">
                      <i class="fa fa-file-payment me-2 text-primary"></i>
                      <span id="paymentModalTitle">Add Payment for Supplier <?=$name?></span>
                    </h6>
                    <button type="button" class="btn-close btn-close-sm" data-bs-dismiss="modal"></button>
                  </div>
                        ...
                        <div class="col-md-4">
                          <label for="payment_type" class="form-label fw-semibold small mb-1 d-flex align-items-center">
                            ...
                            <i class="fa fa-info-circle ms-1 text-primary"
                               ...
                               title="Income = Money RECEIVED from supplier.&#10;Expense = Money SPENT for supplier."></i>
                          </label>
            ...
            <script>
                ...
                <div id="timeline-section" class="tab-section section-scroll">
                  <style>
                    #supplierTimelineSection .timeline {
                        position: relative;
                        padding-left: 25px;
                        border-left: 2px solid #0d6efd33;
                    }
                    #supplierTimelineSection .timeline-date-header {
                        font-size: 0.78rem;
                        font-weight: 700;
                        color: #0d6efd;
                    ...
                    #supplierTimelineSection .timeline-item {
                        position: relative;
                        display: flex;
                        gap: 12px;
                        margin-bottom: 18px;
                    ...
                    #supplierTimelineSection .timeline-date,
                    .timeline-time {
                        font-size: 0.8rem;
                        font-weight: 600;
                        color: #6c757d;
                    }
                    #supplierTimelineSection .timeline-text {
                        font-size: 0.95rem;
                        color: #444;
                        line-height: 1.35rem;
                    }
                    #supplierTimelineSection .timeline-agent {
                        font-size: 0.75rem;
                        color: #0d6efd;
                        margin-top: 2px;
                        display: block;
                    ...
                    <div id="supplierTimelineSection" class="card border-0 shadow-sm rounded-3 mt-2">
                      <div class="card-header bg-white border-bottom-1 d-flex align-items-center justify-content-between">
                        <h5 class="fw-semibold mb-0 small text-primary">
                          <i class="fa fa-stream me-1"></i> Supplier Timeline
                        </h5>
                      ...
                      <div class="card-body py-2" id="supplierTimelineBox" style="max-height:450px; overflow-y:auto;">
                        
                        <!-- ⭐ This wrapper matches your JS selector -->
                        <div id="supplierTimeline">
                ...
                <script>
                  $(function() {
                    const supplierId = <?= $supplier_id ?? 0 ?>;
                    const logURL = "public/ajax/suppliers_recent_actions.php";
                    const $timeline = $('#supplierTimeline');
        ...
        <div class="col-md-4 col-section jright">
            ...
            <div id="recentActionsSection" class="card border-0 shadow-sm rounded-3 mt-2">
              ...
              <div class="card-body py-2" id="supplierLogs" style="max-height: 300px; scrollbar-width: thin; overflow-y:auto;">
        ...
        <div class="modal-body text-dark" id="info">
          <form id="info-wrapper" class="row g-3 text-black">
            ...
            <div class="col-md-4 settinginp settinginpImg">
              <label class="form-label">Upload Side 1</label>
              ...
              <div id="photo1Preview" class="mt-2">
                <?php if (!empty($photo)): ?>
                  <img src="uploads/suppliers/<?= htmlspecialchars($photo) ?>" alt="Photo 1"
            ...
            <div class="col-md-4 settinginp settinginpImg">
              <label class="form-label">Upload Side 2</label>
              <input type="file" class="form-control form-control-sm rounded-pill"
                     name="photo1" id="photo1" accept="image/*">
              <div id="photo2Preview" class="mt-2">
                <?php if (!empty($photo1)): ?>
                  <img src="uploads/suppliers/<?= htmlspecialchars($photo1) ?>" alt="Photo 2"
                       class="img-thumbnail" style="max-width: 100px;">
                <?php endif; ?>
              </div>
            </div>
    ...
    <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
      ...
      <div class="modal-header py-2">
        <h5 class="modal-title fw-semibold d-flex align-items-center" id="viewIdModalLabel">
          <i class="fa fa-id-card me-2"></i> Visiting Card Preview
        </h5>
      ...
      <div class="modal-body bg-light text-center p-4" style="min-height: 75vh;">
        ...
        <div class="tab-content mt-3" id="cardTabContent">
          ...
          <div class="tab-pane fade show active" id="side1" role="tabpanel" aria-labelledby="side1-tab">
            <?php if (!empty($photo)): ?>
              <img src="uploads/suppliers/<?= htmlspecialchars($photo) ?>" 
            ...
            <?php else: ?>
              ...
              <button class="btn btn-sm btn-primary mt-2" onclick="setPhotoId(1)">
                <i class="fa fa-upload me-1"></i> Upload Side 1
              </button>
            <?php endif; ?>
          </div>
          ...
          <div class="tab-pane fade" id="side2" role="tabpanel" aria-labelledby="side2-tab">
            <?php if (!empty($photo1)): ?>
              <img src="uploads/suppliers/<?= htmlspecialchars($photo1) ?>" 
            ...
            <?php else: ?>
              ...
              <button class="btn btn-sm btn-primary mt-2" onclick="setPhotoId(2)">
                <i class="fa fa-upload me-1"></i> Upload Side 2
              </button>
            <?php endif; ?>
          </div>
    ...
    <div class="modal-content rounded-4 shadow-sm">
      ...
      <div class="modal-header bg-white border-bottom">
        <h5 class="modal-title fw-semibold text-primary d-flex align-items-center gap-2" id="viewSitesModalLabel">
          <i class="fa fa-map-marker-alt"></i> Supplier Sites
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <!-- Body -->
      <div class="modal-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <div>
            <small class="text-muted">Manage supplier sites — add multiple sites, update details or remove them.</small>
          </div>
          <div>
...
$(function() {
  ...
  const supplierIdGlobal = <?= isset($supplier_id) ? (int)$supplier_id : 0 ?>;
  ...
  function attachSiteButtons() {
    ...
    $('.delete-site-btn').off('click').on('click', function(){
      ...
      if (site && site.id) {
        ...
        $.post('public/ajax/suppliers_sites.php', { action:'delete', id: site.id, supplier_id: supplierIdGlobal }, function(resp){
          try { 
            // const j = JSON.parse(resp);
            const j = (typeof resp === 'string') ? JSON.parse(resp) : resp;
            if (j.success) { sites.splice(idx-1,1); renderAll(); } else alert(j.error||'Delete failed');
  ...
  /* ------- Fetch from server ------- */
  function fetchSites(supplierId) {
    $tabList.html(`<div class="text-center py-3"><i class="fa fa-spinner fa-spin me-2"></i>Loading...</div>`);
    $content.html('');
    $.post('public/ajax/suppliers_sites.php', { action:'fetch', supplier_id: supplierId }, function(resp) {
      try {
        // const j = JSON.parse(resp);
        const j = (typeof resp === 'string') ? JSON.parse(resp) : resp;
        if (Array.isArray(j)) {
  ...
  function saveSingleSite(idx) {
    ...
    $.post('public/ajax/suppliers_sites.php', payload, function(resp) {
  ...
  $('#saveAllSitesBtn').on('click', function(){
    // gather arrays
    const payload = { action: 'save_bulk', supplier_id: supplierIdGlobal, sites: [] };
    ...
    $.ajax({
      url: 'public/ajax/suppliers_sites.php',
      method: 'POST',
      data: { action: payload.action, supplier_id: payload.supplier_id, sites: JSON.stringify(payload.sites) },
    }).done(function(resp){
  ...
  /* ------- public opener ------- */
  window.openSitesModal = function(supplierId) {
    // if you pass supplierId it will load for that id; else use page-level var
    const cid = supplierId || supplierIdGlobal;
    fetchSites(cid);
    sitesModal.show();
  };
  // auto open if desired:
  // openSitesModal(supplierIdGlobal);
});
</script>
      ...
      <div class="modal-body">
        <div class="mb-2">
          <div class="d-flex flex-wrap gap-2" id="statusButtonsContainer">
            <?php
              foreach($suppliers_statuses as $val => $label): ?>
...
$(function() {
  ...
  function loadContactButtons() {
    $.ajax({
      url: "public/ajax/suppliers_contacts.php",
      type: "POST",
      dataType: "json",
      data: { action: "list", supplier_id: supplierId },
      beforeSend: function() {
...
$(function() {
  ...
  $("#edit-reminder-form").on("submit", function(e) {
    ...
    $.ajax({
      url: "public/ajax/suppliers_reminder_update.php",
      type: "POST",
      data: {
        action: "update",
        reminder_id: id,
    ...
    function loadReminders(refresh = false) {
        ...
        $.post("public/ajax/suppliers_reminder_fetch.php",
    ...
    $("#new-reminder-form").on("submit", function(e) {
       ...
       $.ajax({
           url: "public/ajax/suppliers_reminder_add.php",
           type: "POST",
           data: formData,
           dataType: "json",
           success: function(res) {
...
$(function() {
  ...
  $("#supplier-note-form").on("submit", function(e){
    ...
    $.ajax({
      url: "public/ajax/suppliers_logs.php",
      type: "POST",
      dataType: "json",
      data: { 
        action: "save",
  ...
  function loadNotes(ref = false) {
    ...
    $.post("public/ajax/suppliers_logs.php", 
    ...
    $(document).ready(function(){
        ...
        $("#saveContactInfo").on("click", function () {
          ...
          $("#info :input").each(function () {
            ...
            // Save field via AJAX
            const req = $.ajax({
              url: "public/ajax/suppliers_save.php",
              type: "POST",
              data: {
                supplier_id: "<?= $id ?? 0 ?>",
                field: fieldName,
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(response.success && response.photo){
                        $("#photo1Preview").html('<img src="uploads/suppliers/'+ response.photo +'" alt="Photo 1" class="img-thumbnail" style="max-width: 100px;">');
                        $("#image1").html('<img id="idImage" src="uploads/suppliers/'+response.photo+'" alt="ID Image" class="img-fluid rounded shadow-sm" style="max-height: 70vh; object-fit: contain;">');
                    }
                },
                error: function(){
        ...
        $("#photo1").on("change", function() {
            ...
            $.ajax({
                ...
                success: function(response){
                    // optional: show preview or a ✅ indicator
                    if(response.success && response.photo){
                        $("#photo2Preview").html('<img src="uploads/suppliers/'+ response.photo +'" alt="Photo 2" class="img-thumbnail" style="max-width: 100px;">');
                        $("#image2").html('<img id="idImage" src="uploads/suppliers/'+response.photo+'" alt="ID Image" class="img-fluid rounded shadow-sm" style="max-height: 70vh; object-fit: contain;">');
                    }
                },
                error: function(){
                    console.error("Error uploading photo.");
        ...
        //     $.ajax({
        //         url: "public/ajax/suppliers_logs_save.php",
        //         type: "POST",
        ...
        //     $.post("public/ajax/suppliers_logs_fetch.php", 
        ...
        function loadCalls(reset = false) {
            ...
            $.post("public/ajax/suppliers_call_logs.php", 
...
function reloadContact() {
    $.post("public/ajax/suppliers_fetch.php", 
      { supplier_id: <?=$id??0?>},
      function(res){
        if(res.success==1){
            Object.entries(res.fields).forEach(([key, val],ind) => {
                if(key=='photo'&&val!='') {
                    // $("#photod").show();
                    $("#photodimg").attr("src","uploads/suppliers/"+val);
                }
                else if(key=='photo1'&&val!='') {
                    // $("#photo1d").show();
                    $("#photo1dimg").attr("src","uploads/suppliers/"+val);
                }
                else if(key=='type') {
                    $("#typed").text(val);
                }
...
function loadEmailList() {
  ...
  fetch(`public/ajax/suppliers_get_emails.php?id=<?=$id??0?>&page=${currentPage}&limit=${perPage}`)
...
function loadEmailContent(emailId, button) {
  ...
  fetch(`public/ajax/suppliers_get_emails_details.php?id=${emailId}`)
    .then(response => response.json())
    .then(email => {
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <form id="requirementForm" enctype="multipart/form-data">
        <div class="modal-body">
          <input type="hidden" name="supplier_id" id="supplier_id" value="<?= $supplier_id ?? 0 ?>">
...
let jobTitles = [];
$(function () {
  const supplierID = <?= isset($supplier_id) ? intval($supplier_id) : 0 ?>;
  const ajaxURL = "public/ajax/suppliers_requirements.php";
  ...
  function loadRequirements() {
    $.ajax({
      url: ajaxURL,
      type: "POST",
      data: { action: "fetch", supplier_id: supplierID },
    ...
    <div class="modal-content border-0 shadow-lg rounded-4">
      ...
      <form id="contactForm" enctype="multipart/form-data">
        <div class="modal-body p-4">
          ...
          <input type="hidden" name="supplier_id" id="contact_supplier_id" value="<?= $supplier_id ?? 0 ?>">
          ...
          <!-- Visiting Card Uploads -->
          <div class="row g-3 align-items-center">
            <div class="col-md-6">
              <label class="form-label fw-semibold small mb-1">Visiting Card - Side 1</label>
            ...
            <div class="col-md-6">
              <label class="form-label fw-semibold small mb-1">Visiting Card - Side 2</label>
    ...
    <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
      ...
      <div class="modal-header py-2">
        <h5 class="modal-title fw-semibold d-flex align-items-center" id="viewContactCardLabel">
          <i class="fa fa-id-card me-2"></i> Visiting Card
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
<script>
$(document).ready(function(){
  const supplierID = <?= isset($supplier_id) ? $supplier_id : 0 ?>;
  const ajaxURL = "public/ajax/suppliers_contacts.php";
  // Load all contacts
  ...
  $(document).on("click", ".edit-contact", function(){
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        let cardFront = data.photo1 ? `<img src="uploads/suppliers/contacts/${data.photo1}" class="img-thumbnail" style="max-width:100px;">` : "";
        let cardBack  = data.photo2  ? `<img src="uploads/suppliers/contacts/${data.photo2}" class="img-thumbnail" style="max-width:100px;">` : "";
...
function viewContactCard(contactId) {
  ...
  $.ajax({
    ...
    success: function(data) {
      if (data) {
        const side1 = data.photo1 ? `uploads/suppliers/contacts/${data.photo1}` : "";
        const side2 = data.photo2 ? `uploads/suppliers/contacts/${data.photo2}` : "";
    ...
    <div class="modal-content">
      ...
      <form id="documentForm" enctype="multipart/form-data">
        <div class="modal-body py-2 px-3">
          ...
          <input type="hidden" name="supplier_id" id="doc_supplier_id" value="<?= $supplier_id ?? 0 ?>">
...
$(document).ready(function(){
  ...
  const supplierID = <?= isset($supplier_id) ? $supplier_id : 0 ?>;
  const ajaxURL = "public/ajax/suppliers_documents.php";
...
/* ---------- MAIN SCRIPT ---------- */
$(function() {
  const ajaxURL = "public/ajax/suppliers_quotations.php";
  const supplierId = <?= $supplier_id ?? 0 ?>;
  ...
  loadQuotations();
    ...
    $(document).on('click', '.view-versions', function() {
      ...
      $.post(ajaxURL, { action: 'get_versions', ref_no: refNo, supplier_id: supplierId }, function(res) {
        try {
  ...
  $('#addQuotationBtn, #quickCreateQuotationBtn').on('click', function() {
    ...
    $.post("public/ajax/suppliers_quotation_editor.php", { action: 'load_editor', supplier_id: supplierId }, function(res) {
      try {
        const data = JSON.parse(res);
...
$(function() {
  const supplierId = <?= $supplier_id ?? 0 ?>;
  const logURL = "public/ajax/suppliers_recent_actions.php";
  const $logBox = $('#supplierLogs');

  // 🔹 Convert JSON data to HTML (list format)
  function renderLogs(logs) {
    if (!logs || !logs.length) {
      return `<div class="text-muted small text-center py-3">No recent activity found for this supplier.</div>`;
    }
  ...
  function loadLogs() {
    if (!supplierId) {
      $logBox.html(`<div class="text-muted small text-center py-3">No supplier selected.</div>`);
      return;
    }
    ...
    $.ajax({
      ...
      type: "POST",
      dataType: "json",
      data: { supplier_id: supplierId, start: 0, length: 10, draw: 1 },
      success: function(res) {
        if (!res.data || !Array.isArray(res.data) || res.data.length === 0) {
          $logBox.html(`<div class="text-muted small text-center py-3">No recent actions found for this supplier.</div>`);
          return;
        }
...
$(function () {
  ...
  const ajaxURL = "public/ajax/suppliers_invoices.php";
  const supplierId = <?= $supplier_id ?? 0 ?>;
            ...
            res.data.forEach(inv => {
                ...
                const docBtn = inv.document
                  ? `<button class='btn btn-light border view-document'
                             data-file='uploads/suppliers/invoices/${inv.document}'
                ...
                <div class="card border-0 shadow-sm rounded-3 mb-2">
                  <div class="card-body py-2 px-3 d-flex justify-content-between align-items-start">
                    ...
                    <div>
                      <!-- AMOUNT -->
                      <div class="fw-bold fs-6 text-primary mb-1">
                        <?= $currency_symbol ?? '' ?>${inv.invoice_amount}
                      </div>
                      <!-- TYPE + CATEGORY -->
                      ...
                      <div class="text-muted small mb-1">
                        <i class="fa fa-calendar me-1"></i>${inv.invoice_dated}
                        <i class="fa fa-calendar-check ms-3 me-1"></i>${inv.due_dated}
                      </div>
                      <!-- NOTES -->
                      <div class="small text-dark">
                        ${
                          inv.notes
                            ? `<i class="fa fa-sticky-note me-1"></i>${inv.notes}`
  ...
  $(document).on("click", ".edit-invoice", function () {
      ...
      $.post(ajaxURL, { action: "fetch", supplier_id: supplierId }, function (res) {
          ...
          if (inv.document) {
              ...
              // $("#documentPreview").html(`
              //     <a href="uploads/suppliers/invoices/${inv.document}" target="_blank" class="btn btn-sm btn-outline-primary">
...
$(function() {
  ...
  const ajaxURL = "public/ajax/suppliers_payments.php";
  const supplierId = <?= $supplier_id ?? 0 ?>;
          ...
          const docBtn = docsArr.length
            ? docsArr
                .map((d) => {
                  ...
                  if (typeof d === "object") {
                    file = d.file;
                    url = d.url || `uploads/suppliers/payments/${file}`;
                    type = d.type || (file.toLowerCase().endsWith(".pdf") ? "pdf" : "image");
                    name = d.name || "";
                  } else {
                    file = d;
                    url = `uploads/suppliers/payments/${file}`;
  ...
  $("#addpaymentBtn").on("click", function() {
    ...
    $("#paymentModalTitle").text("Add Payment for Supplier <?=$name?>");
  ...
  $("#paymentForm").on("submit", function(e) {
    ...
    $(document).on("click", ".edit-payment", function () {
      ...
      $.post(ajaxURL, { action: "get", id: id }, function (res) {
        ...
        if (Array.isArray(inv.documents) && inv.documents.length) {
          inv.documents.forEach((doc) => {
            ...
            if (typeof doc === "object") {
              ...
              file = doc.file;
              label = doc.name || "";
              url = doc.url || `uploads/suppliers/payments/${file}`;
          ...
          try {
            ...
            if (Array.isArray(parsed)) {
              ...
              existingDocs.push({
                name: parsed,
                label: "",
                url: `uploads/suppliers/payments/${parsed}`,
            ...
            inv.documents
              ...
              .forEach((f) =>
                existingDocs.push({
                  name: f,
                  label: "",
                  url: `uploads/suppliers/payments/${f}`,
        ...
        $("#documentPreviewp").empty();
        $("#paymentModalTitle").text("Edit Payment of Supplier <?=$name?>");
        modal.show();
      }, "json");
    });
  ...
  $(document).on("click", ".delete-payment", function() {
    ...
    $.post(ajaxURL, { action: "delete", id: id, supplier_id: supplierId }, function(res) {
...
(function(){
  ...
  function fetchWhatsApp(prependOlder=false){
    ...
    fetch('public/ajax/contacts_get_whatsapp.php', {
      ...
      body: `contact_id=${encodeURIComponent(supplierId)}&contact_type==${encodeURIComponent('Supplier')}&offset=${encodeURIComponent(offset)}&limit=${encodeURIComponent(LIMIT)}`
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function doSend(message) {
    ...
    fd.append('contact_type', 'Supplier');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  params.set('contact_type', 'Supplier');
