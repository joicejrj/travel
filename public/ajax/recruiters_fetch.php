...
// $getc = $db->get('recruiters', ['id' => $supplier_id],'name, company, phones, phone, whatsapp, email, address, city, state, country, services, website, type, source, photo, photo1');
$getc = $db->get('recruiters', ['id' => $supplier_id],'name, company, industry, phone, email, country, type, photo, photo1');
