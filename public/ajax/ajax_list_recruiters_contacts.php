<?php
// public/ajax/ajax_list_recruiters_contacts.php
header('Content-Type: application/json; charset=utf-8');
require_once __DIR__ . '/../../config/db.php';

$recruiter_id = isset($_GET['recruiter_id']) ? (int) $_GET['recruiter_id'] : 0;
$limit = isset($_GET['limit']) ? (int)$_GET['limit'] : 1000;
$limit = ($limit > 0 && $limit <= 5000) ? $limit : 1000;

if (!$recruiter_id) {
    echo json_encode(['success' => false, 'error' => 'missing_recruiter_id']);
    exit;
}
