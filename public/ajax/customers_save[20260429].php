...
$allowed = ['company','name','phone','whatsapp','email','source','type','industry','trn','address','city','state','country','website','services','google_rating','agent_id','fil_domains','fil_emails','enable_email','enable_whatsapp','dob']; // add photo
