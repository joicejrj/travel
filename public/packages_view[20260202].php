    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <small class="text-muted">Cost, markup, and commission summary</small>
        </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-md-6">
          <div class="border rounded p-3 h-100">
            ...
            <div class="fw-semibold mt-1">
              <?= ucfirst($pricing['markup_type'] ?? '—') ?>
              —
              <?= number_format($pricing['markup_value'] ?? 0, 2) ?>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="border rounded p-3 h-100">
            ...
            <div class="fw-semibold mt-1">
              <?= ucfirst($pricing['commission_type'] ?? '—') ?>
              —
              <?= number_format($pricing['commission_value'] ?? 0, 2) ?>
            </div>
          </div>
        </div>
