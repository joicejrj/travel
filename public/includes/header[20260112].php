...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm mb-4">
  <div class="container-fluid">
    ...
    <!-- Brand -->
    <a class="navbar-brand fw-semibold text-primary1" href="index.php?page=daily_interactions">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        ?>
        <li class="nav-item">
          <a class="nav-link<?= ($_GET['page'] ?? '') === 'daily_interactions' ? ' active fw-semibold text-primary' : '' ?>" href="?page=daily_interactions">
            <i class="fas fa-chart-line me-1 text-secondary"></i> Dashboard
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu shadow-sm" aria-labelledby="configDropdown">
            ...
            <li>
              <a class="dropdown-item <?= $current_page=='applicants' ? ' active1 fw-semibold text-primary' : '' ?>"
                 href="?page=applicants">
                <i class="fas fa-suitcase me-2 text-muted"></i> Applicants
              </a>
            </li>
          </ul>
        </li>
