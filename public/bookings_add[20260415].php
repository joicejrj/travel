    ...
    <form id="detailForm" data-current-id="" novalidate>
      ...
      <div class="wizard-step" id="wiz-step-2" aria-hidden="true" style="display:none;">
        ...
        <script>
          ...
          var rulesBtn = "";
          if(o.showfare) {
            rulesBtn = `<button type="button" class="btn btn-outline-info btn-sm btn-select-rules me-1" onclick="loadSeatMap('${o.offeringId}', '${o.frProductId}',${i})" title="View Seat Map"> <i class="fa fa-th"></i> Seats</button><button type="button" class="btn btn-outline-primary btn-sm btn-select-rules me-1"
