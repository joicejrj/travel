          ...
          <div id="tourDiv" class="border rounded-3 p-3 pt-0 bg-light" style="display:none;">
              ...
              <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-nowrap">
                  ...
                  <input type="date"
                         ...
                         style="max-width:180px; padding: 6px;" value="<?=$date?>"
                         required>
                </div>
            ...
            <script>
              ...
              function loadTourPackagesByDate(date) {
                ...
                fetch('public/ajax/ajax_get_tour_packages.php?travel_date=' + encodeURIComponent(date))
                  .then(r => r.json())
                  .then(json => {
                    ...
                    if (!json.success) {
                      document.getElementById('tourResults').innerHTML =
                        `<div class="alert alert-warning">No packages available for selected date</div>`;
                      return;
                    }
            ...
            <div class="mb-1" id="tourtrano" style="display: none;">
          ...
          <div id="travellerDiv" class="border rounded-3 p-3 mt-4" style="display:none">
            ...
            <script>
              ...
              function updatePriceSummary() {
                ...
                const base =
                  parseFloat(document.getElementById('selected_tour_price').value || 0);

                const final = Math.max(0, base - (APPLIED_DISCOUNT || 0));
