              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form id="supplier-note-form">
                    <div class="mb-2">
                      <input type="hidden" name="uname" value="<?=isset($current_agent_name) ? $current_agent_name : 'aleena'?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="edit-reminder-form" class="mb-3 p-2">
          ...
          <div class="mb-2">
            <div class="d-flex flex-wrap gap-1">
              <input type="radio" class="btn-check" name="type" id="edit-type-callback" value="Callback" autocomplete="off">
              <label class="btn btn-outline-primary btn-xs rtype rounded-pill px-2 py-1" for="edit-type-callback">Callback</label>

              <input type="radio" class="btn-check" name="type" id="edit-type-followup" value="Follow-up" autocomplete="off">
              <label class="btn btn-outline-primary btn-xs rtype rounded-pill px-2 py-1" for="edit-type-followup">Follow-up</label>

              <input type="radio" class="btn-check" name="type" id="edit-type-sendemail" value="Send Email" autocomplete="off">
              <label class="btn btn-outline-primary btn-xs rtype rounded-pill px-2 py-1" for="edit-type-sendemail">Send Email</label>

              <input type="radio" class="btn-check" name="type" id="edit-type-other" value="Other" autocomplete="off">
              <label class="btn btn-outline-primary btn-xs rtype rounded-pill px-2 py-1" for="edit-type-other">Other</label>
            </div>
          </div>
...
function openEditReminderModal(reminder) {
  ...
  ['Callback','Follow-up','Send Email','Other'].forEach(type => {
    const radio = document.getElementById('edit-type-' + type.toLowerCase().replace(' ',''));
...
$(document).ready(function() {
    ...
    function loadReminders(refresh = false) {
        ...
        if (refresh) {
            ...
            // $("#load-more-reminders").prop("disabled", false).text("Load More");
        }
